        ...
        <div className="container mx-auto px-0 w-full mt-[20px]">
          <div className="text-left lg:text-left">
            <div className="col-span-full xl:col-span-7">        
              ...
              {(data?.length > 0 ) && ( <h3 className='lg:text-base sm:text-base font-normal mb-8 text-left'>Estamos procesando tu reserva, en la tarjeta de abajo vas a poder encontrar todos los detalles de la misma. En breve nos contactaremos para informate por el estado de tu lavado</h3>)}
